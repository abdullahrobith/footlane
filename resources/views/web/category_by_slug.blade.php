                    ...
                    <div class="card product-card h-100 shadow-sm">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                <span class="fw-bold" style="color: #FFC107;">Rp {{ number_format($product->price, 0, ',', '.') }}</span>
                                <a href="{{ route('product.show', $product->slug) }}" class="btn btn-sm" style="border: 1px solid #FFC107; color: #FFC107;">Lihat Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
